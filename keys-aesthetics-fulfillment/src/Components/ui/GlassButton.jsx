...
export default function GlassButton({
  ...
  return <button className={cn("relative rounded-xl border backdrop-blur-xl", "shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2)]", "transition-all duration-300 font-medium", "hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_20px_rgba(255,255,255,0.1)]", "active:scale-[0.98]", "disabled:opacity-50 disabled:cursor-not-allowed", variants[variant], sizes[size], className)} {...props}>
      {children}
    </button>;
}