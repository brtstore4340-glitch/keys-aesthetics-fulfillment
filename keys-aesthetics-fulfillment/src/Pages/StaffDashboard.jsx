  ...
  return <DashboardLayout user={currentUser}>
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            {myOrders.length === 0 ? <p className="text-muted-foreground text-center py-8">
                No orders yet. Create your first order!
              </p> : <div className="space-y-2">
                {myOrders.slice(0, 5).map(order => <div key={order.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
