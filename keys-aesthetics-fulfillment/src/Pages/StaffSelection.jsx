...
export default function StaffSelection() {
  ...
  const loginUser = user => {
    ...
    const redirectPath = user.role === 'admin' ? '/admin/dashboard' : user.role === 'staff' ? '/staff/dashboard' : '/accounting/dashboard';
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-5xl">
        {selectedUser ? <div className="flex justify-center">
            <PinPad userName={selectedUser.name} onSubmit={handlePinSubmit} onCancel={() => setSelectedUser(null)} />
