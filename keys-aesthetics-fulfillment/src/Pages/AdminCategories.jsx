  ...
  return <DashboardLayout user={currentUser}>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {categories.length === 0 ? <div className="col-span-full text-center py-12 text-muted-foreground">
              No categories yet. Add your first category!
            </div> : categories.map(category => <div key={category.id} className="border rounded-lg p-4 space-y-3">
                {category.image_url && <img src={category.image_url} alt={category.name} className="w-full h-32 object-cover rounded" />}
                <div>
