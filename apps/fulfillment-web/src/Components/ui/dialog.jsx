...
(({ className, children, ...props }, ref) => (
  React.createElement(DialogPortal, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 33}}
    , React.createElement(DialogOverlay, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 34}} )
    , React.createElement(DialogPrimitive.Content, {
      ...
      , React.createElement(DialogPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"              , __self: this, __source: {fileName: _jsxFileName, lineNumber: 44}}
        , React.createElement(X, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 45}} )
        , React.createElement('span', { className: "sr-only", __self: this, __source: {fileName: _jsxFileName, lineNumber: 46}}, "Close")
      )
    )
  )
))
