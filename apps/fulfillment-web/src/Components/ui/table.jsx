...
(({ className, ...props }, ref) => (
  React.createElement('div', { className: "relative w-full overflow-auto"  , __self: this, __source: {fileName: _jsxFileName, lineNumber: 8}}
...
(({ className, ...props }, ref) => (
  React.createElement('thead', { ref: ref, className: cn('[&_tr]:border-b', className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 22}} )
))
